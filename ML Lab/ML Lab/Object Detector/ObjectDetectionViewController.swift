...
class ObjectDetectionViewController: UIViewController {
    ...
    private let viewModel: ObjectDetectorViewModel = ObjectDetectorViewModel()
    ...
    private func setupUI() {
        ...
        self.addSubSwiftUIView(ObjectDetectorScreen(viewModel: viewModel, onAction: onAction), to: view)
    }
    
    // MARK: - Actions -
    
    private func onAction(_ action: ObjectDetectionAction) {
...
extension ObjectDetectionViewController: PHPickerViewControllerDelegate, UINavigationControllerDelegate {
