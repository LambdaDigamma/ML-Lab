...
///
/// The Object Detector creates and reuses an instance of a Core ML image object detector inside a ``VNCoreMLRequest``.
...
open class ObjectDetector {
    ...
    public static func createImageClassifier() -> VNCoreMLModel {
        ...
        let objectDetectorWrapper = try? YOLOv3Int8LUT(configuration: defaultConfig) // YOLOv3_Tiny_Int8_LUT(configuration: defaultConfig)
        
        guard let imageClassifier = objectDetectorWrapper else {
    ...
    private func createImageClassificationRequest() -> VNImageBasedRequest {
        ...
        let imageClassificationRequest = VNCoreMLRequest(
            model: ObjectDetector.imageClassifier,
    ...
    private func visionRequestHandler(_ request: VNRequest, error: Error?) {
        ...
        predictions = observations.compactMap { observation in
            ...
            return Prediction(
                classification: label.identifier,
